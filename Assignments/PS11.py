...
def registration():
    ...
    if name1 == '' or contact1 == '' or email1 == '' or gender1 == '' or city1 == '' or state1 == '':
        ...
        with open("Studinfo.txt", "a") as fp:
            if gender == 1:
                fp.write(" " + name1 + " " + contact1 + " " +
                        email1 + " Male " + city1 + " " + state1)
            else:
                fp.write(" " + name1 + " " + contact1 + " " +
                        email1 + " Female " + city1 + " " + state1)
...
def registration_form():
    ...
    Label(registration_screen, width="250", text="Please Enter the details below",
    ...
    Radiobutton(registration_screen, text='Male', variable=gender,
                value=1).place(x=85, y=161)
    Radiobutton(registration_screen, text='Female', variable=gender,
                value=2).place(x=150, y=161)
    ...
    citychoosen['values'] = ('Mumbai', 'Pune', "Chennai", "Kolkata", "Bengluru",
                            "Patna", "Nagpur")
    citychoosen.current()
    ...
    statechoosen['values'] = (
        'Maharastra', 'Karnataka', "Andra Pradesh", "West Bangal", "Bihar", "Meghalaya",
        "Uttar Pradesh")
